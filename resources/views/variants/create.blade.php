        ...
        <div class="variant-wrapper">
            <div class="variant-section">
                <div class="variant-head d-flex justify-content-center p-5">
                    <span class="fs-3">Add a new Variant</span>
                </div>
                <div class="variant-body">
                    <div class="form-wrapper container col-8">
                        <form action="{{ route('variants.store') }}" class="form" method="POST">
                            @csrf @method('POST')
                            <div class="form-section">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                        <input type="text" name="variant_code" id="variant_code" value="{{ old('variant_code') }}"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-10">
                                            <textarea name="description" id="description" class="form-control @error('desccription') is-invalid @enderror" cols="10" rows="4">{{ old('description') }}</textarea>
                                        @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
